			...
			acf_add_local_field_group( [
				...
				'fields' => [
					...
					[
						...
						'label'             => __( 'Site Plugin Position', 'seq-pac-plugin' ),
						'name'              => 'spp_site_plugin_link_position',
						'type'              => 'button_group',
						'instructions'      => __( 'Make the site-specific plugin admin page a top-level link.', 'seq-pac-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'choices'           => [
							'default' => __( 'Under Plugins', 'seq-pac-plugin' ),
					...
					[
						...
						'label'             => __( 'Site Plugin Label', 'seq-pac-plugin' ),
						'name'              => 'spp_site_plugin_link_label',
						'type'              => 'text',
						'instructions'      => __( 'Change the label of the link to this page.', 'seq-pac-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
					...
					[
						...
						'label'             => __( 'Site Plugin Icon', 'seq-pac-plugin' ),
						'name'              => 'spp_site_plugin_link_icon',
						'type'              => 'text',
						'instructions'      => __( 'Enter a Dashicons CSS class for the icon of the link to this page.', 'seq-pac-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
					...
					[
						...
						'label'             => __( 'Classic Editor', 'seq-pac-plugin' ),
						'name'              => 'spp_classic_editor',
						'type'              => 'true_false',
						'instructions'      => __( 'Disables the block editor (a.k.a. Gutenberg) and restores the TinyMCE editor.', 'seq-pac-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'message'           => __( 'Use the classic editor', 'seq-pac-plugin' ),
						'default_value'     => 0,
						'ui'                => 1,
