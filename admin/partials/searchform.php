...
$label       = apply_filters( 'spp_search_label', esc_html__( 'Search for:', 'seq-pac-plugin' ) );
$placeholder = apply_filters( 'spp_search_placeholder', esc_attr( esc_html__( 'Search ', 'seq-pac-plugin' ) . get_bloginfo( 'name' ) ) );
$submit      = apply_filters( 'spp_search_submit', esc_html__( 'Submit', 'seq-pac-plugin' ) );
?>
