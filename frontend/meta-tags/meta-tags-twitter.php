...
<?php if ( ! is_404() ) : ?>
<meta name="twitter:url" content="<?php esc_attr( esc_url( do_action( 'spp_meta_url_tag' ) ) ); ?>" />
<?php endif; ?>
...
<?php endif; ?>
<meta name="twitter:image:src" content="<?php esc_attr( do_action( 'spp_meta_image_tag' ) ); ?>" />
