...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( spp_acf_options() ) {
            ...
            $options = get_field( 'spp_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( spp_acf_options() ) {
            $links = get_field( 'spp_links_manager', 'option' );
        } else {
            $links = get_option( 'spp_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( spp_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'spp_hide_appearance' );
            $plugins    = get_option( 'spp_hide_plugins' );
            $users      = get_option( 'spp_hide_users' );
            $tools      = get_option( 'spp_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( spp_acf_options() ) {
            ...
            $menus_link   = get_field( 'spp_menus_position', 'option' );
            $widgets_link = get_field( 'spp_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'spp_menus_position' );
            $widgets_link = get_option( 'spp_widgets_position' );
