...
class Extend_ACF {
	...
	public function admin_styles() {
		...
		wp_enqueue_style( SPP_ADMIN_SLUG . '-acf-admin', SPP_URL . 'includes/acf/assets/css/admin.min.css', [], SPP_VERSION, 'screen' );
	...
	public function admin_scripts() {
		...
		wp_enqueue_script( SPP_ADMIN_SLUG . '-acf-admin', SPP_URL . 'includes/acf/assets/js/admin.min.js', [ 'jquery' ], SPP_VERSION, true );
