...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'spp_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( spp_acf_options() ) {
			...
			$blog_image    = get_field( 'spp_meta_blog_image', 'option' );
			$default_image = get_field( 'spp_meta_default_image', 'option' );
