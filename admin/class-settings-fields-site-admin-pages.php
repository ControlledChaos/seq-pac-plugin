...
class Settings_Fields_Site_Admin_Pages {
	...
	private function dependencies() {
		...
		require SPP_PATH . 'admin/partials/field-callbacks/class-admin-pages-callbacks.php';
	...
	public function settings() {
		...
		add_settings_section(
			...
			__( 'Admin Pages Settings', 'seq-pac-plugin' ),
			[],
			'spp-site-admin-pages'
		);
		...
		add_settings_field(
			...
			__( 'Admin Header', 'seq-pac-plugin' ),
			[ Partials\Field_Callbacks\Admin_Pages_Callbacks::instance(), 'admin_header' ],
			'spp-site-admin-pages',
			'spp-site-admin-pages',
			[ esc_html__( 'Add the site title, site tagline, and a nav menu to the top of admin pages.', 'seq-pac-plugin' ) ]
		);
		...
		add_settings_field(
			'spp_use_custom_sort_order',
			__( 'Drag & Drop Sort Order', 'seq-pac-plugin' ),
			[ Partials\Field_Callbacks\Admin_Pages_Callbacks::instance(), 'custom_sort_order' ],
			'spp-site-admin-pages',
			'spp-site-admin-pages',
			[ esc_html__( 'Add drag & drop sort order functionality to post types and taxonomies.', 'seq-pac-plugin' ) ]
		);
		...
		add_settings_field(
			'spp_footer_credit',
			__( 'Admin Footer Credit', 'seq-pac-plugin' ),
			[ Partials\Field_Callbacks\Admin_Pages_Callbacks::instance(), 'footer_credit' ],
			'spp-site-admin-pages',
			'spp-site-admin-pages',
			[ esc_html__( 'The "developed by" credit.', 'seq-pac-plugin' ) ]
		);
		...
		add_settings_field(
			'spp_footer_link',
			__( 'Admin Footer Link', 'seq-pac-plugin' ),
			[ Partials\Field_Callbacks\Admin_Pages_Callbacks::instance(), 'footer_link' ],
			'spp-site-admin-pages',
			'spp-site-admin-pages',
			[ esc_html__( 'Link to the website devoloper.', 'seq-pac-plugin' ) ]
		);
 ...
 */
function spp_settings_fields_site_admin_pages() {
...
spp_settings_fields_site_admin_pages();