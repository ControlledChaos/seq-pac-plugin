...
namespace Seq_Pac_Plugin\Includes\Media;
...
class Media {
	...
	private function dependencies() {
		...
		include_once SPP_PATH . 'includes/media/class-svg-support.php';

		// Replace WP gallery shortcode if Fancybox option is used.
		$fancybox = get_option( 'spp_enqueue_fancybox_script' );

		if ( $fancybox ) {
			require_once SPP_PATH . 'includes/media/class-gallery-shortcode.php';
		}
	...
	public function rss_featured_images( $content ) {
		...
		$size = apply_filters( 'spp_rss_featured_image_size', 'medium' );
