...
$tabs = [
    ...
    sprintf(
        ...
        esc_html__( 'Dashboard', 'seq-pac-plugin' )
    ),
    ...
    sprintf(
        ...
        esc_html__( 'Admin Menu', 'seq-pac-plugin' )
    ),
    ...
    sprintf(
        ...
        esc_html__( 'Meta/SEO', 'seq-pac-plugin' )
    )

];

// Apply a filter to the tabs array for adding tabs.
$page_tabs = apply_filters( 'spp_tabs_site_settings', $tabs );
...
if ( 'dashboard' == $active_tab  ) {
    $section = 'spp-site-dashboard';
    $fields  = 'spp-site-dashboard';
} elseif ( 'admin-menu' == $active_tab ) {
    $section = 'spp-site-admin-menu';
    $fields  = 'spp-site-admin-menu';
...
$do_section = apply_filters( 'spp_section_site_settings', $section );
$do_fields  = apply_filters( 'spp_fields_site_settings', $fields );
 ...
 */
if ( 'dashboard' == $active_tab  ) {
    $save = __( 'Save Dashboard', 'seq-pac-plugin' );
} elseif ( 'admin-menu' == $active_tab ) {
...
$button = apply_filters( 'spp_save_site_settings', $save );
...
<div class="wrap">
	<?php echo sprintf(
        ...
        get_bloginfo( 'name' ),
        esc_html__( 'Settings', 'seq-pac-plugin' )
    ); ?>
    <p class="description"><?php esc_html_e( 'Customize the way WordPress is used.', 'seq-pac-plugin' ); ?></p>
