...
namespace Seq_Pac_Plugin\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'spp-customizer-reset', SPP_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'spp-customizer-reset', '_SPPCustomizerReset', [
			'reset'   => __( 'Reset', 'seq-pac-plugin' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'seq-pac-plugin' ),
			'nonce'   => [
