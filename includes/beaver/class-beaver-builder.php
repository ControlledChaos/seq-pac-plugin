...
class SPP_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once SPP_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once SPP_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['spp-custom-beaver-field'] = SPP_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'spp-beaver-fields', SPP_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'spp-beaver-fields', SPP_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$spp_beaver_builder = new SPP_Beaver_Builder;