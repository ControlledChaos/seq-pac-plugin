...
class Dashboard_Callbacks {
	...
	public function hide_try_gutenberg( $args ) {
		...
		$option = get_option( 'spp_hide_try_gutenberg' );

		$html = '<p><input type="checkbox" id="spp_hide_try_gutenberg" name="spp_hide_try_gutenberg" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="spp_hide_try_gutenberg"> '  . $args[0] . '</label></p>';
